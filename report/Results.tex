...
Figure \ref{f:grammars} summarizes the three grammars we investigate. We have not been able to provide an efficient  implementation of shortest derivation extraction with full estimation.
