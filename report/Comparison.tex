...
The commonly used training section of the WSJ treebank (section 2-21) was preprocessed in {\tt disco-dop} by removing functions and binarizing the trees with Markovization (h=1, v=1, that is, a singular horizontal and vertical context). %\footcite{klein2003}. 
%UITLEG/ CITATIE
